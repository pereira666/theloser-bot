		...
		try {
			...
			switch(command) {
				...
				case 'dono':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* CarlosX\n*wa.me/+556993899391'})
					break
				case 'belle2':
					memein = await kagApi.memeindo()
				...
				case 'bomdia':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://i.ibb.co/12YfrQM/images-5.jpg`)
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*X'})
					break
				case 'mia1':
					memein = await kagApi.memeindo()
